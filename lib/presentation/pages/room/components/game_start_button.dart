      ...
      child: Stack(
        children: [
          ...
          Positioned(
            top: 0,
            left: 0,
            child: _corner(theme: theme, flipX: false, flipY: false),
          ),
          Positioned(
            top: 0,
            right: 0,
            child: _corner(theme: theme, flipX: true, flipY: false),
          ),
          Positioned(
            bottom: 0,
            left: 0,
            child: _corner(theme: theme, flipX: false, flipY: true),
          ),
          Positioned(
            bottom: 0,
            right: 0,
            child: _corner(theme: theme, flipX: true, flipY: true),
          ),
        ],
      ),
    );
