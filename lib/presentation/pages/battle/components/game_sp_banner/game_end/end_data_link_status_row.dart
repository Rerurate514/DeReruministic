...
class EndDataLinkStatusRow extends StatelessWidget {
  const EndDataLinkStatusRow({required this.color, super.key});
    ...
    return UiFlashingWidget(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            l10n.battle_page_sp_banner_game_end_data_link_disconnected_text,
