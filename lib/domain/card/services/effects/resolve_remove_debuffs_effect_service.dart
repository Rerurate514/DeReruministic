...
part 'resolve_remove_debuffs_effect_service.g.dart';

@riverpod
ResolveRemoveDebuffsEffectService resolveRemoveDebuffsEffectService(Ref ref) {
  return ResolveRemoveDebuffsEffectService();
}

class ResolveRemoveDebuffsEffectService {
  ApplyActionResult execute({
    required GameState state,
    required CardEffectRemoveDebuffs effect,
    ...
    final newTargetPlayer = targetPlayer.copyWith(
      debuffs: targetPlayer.debuffs.removeDebuffEffect(effect),
    );
    ...
    final step = GameStepEvent.debuffRemoved(
